                            ...
                            <div class="col-lg-6 login-form mx-auto">
                                ...
                                <form class="text-white" action="proses/proses_register.php" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control form-control-lg" placeholder="No. Telepon" name="telp">
                                    </div>
                                    <div class="form-group">
                                        <label class="text-white">Alamat</label>
                                        <textarea name="alamat" id="alamat" class="form-control form-control-lg" cols="10" rows="5" placeholder="Alamat"></textarea>
                                    </div>
                                    <div class="form-group">
